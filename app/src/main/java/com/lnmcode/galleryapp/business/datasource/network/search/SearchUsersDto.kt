...
import com.lnmcode.galleryapp.business.datasource.network.search.SearchUserProfileImage
...
data class SearchUsers (
    ...
    @SerializedName("links"              ) val links             : SearchUserLinks,
    @SerializedName("profile_image"      ) val profileImage      : SearchUserProfileImage,
